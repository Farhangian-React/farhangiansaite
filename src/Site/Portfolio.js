  ...
  return (
    <>
        ...
        <div className='blurstyle'>
            <p  className=' text-lg md:text-3xl text-[#8229d5] text-center pb-2 font-bold'>نمونه کارها  </p>
            <p className='text-sm text-center text-[#f9f9f9] pt-2'>...و پروژه های مینی مال مختلف </p>
        </div>
     ...
     md:h-[200px] fixed bottom-[15px] left-[5%] right-[5%] mx-auto rounded-br-3xl rounded-tl-3xl 
      bg-gradient-to-t from-[#8229d5] to-[#f9f9f9]   '>
       ...
       <p className='text-2xl text-center font-bold text-[#1e142c] mr-5'>سایت پراپی</p>  </div>
       
        <p dir='rtl' className='text-md text-justify font-sans text-[#1e142c] mr-5 my-1'>
 ...
 وارد  <a className='text-[#f9f9f9] px-1 ' href='https://propiy.com/fa'  >  سایت</a> شوید 
     ...
     md:h-[200px] fixed bottom-[15px] left-[5%] right-[5%] mx-auto rounded-br-3xl rounded-tl-3xl 
      bg-gradient-to-t from-[#8229d5] to-[#f9f9f9]   '>
       ...
       <p className='text-2xl text-center font-bold text-[#1e142c] mr-5'>سایت فروشگاهی شیائومی</p>  </div>
       
        <p dir='rtl' className='text-md text-justify font-sans text-[#1e142c] mr-5 my-1'>پروژه بصورت تیمی توسعه داده شده است و در فرانت اند آن از react-js استفاده شده است. برای مشاهده ی بیشتر وارد 
   <a className='text-[#f9f9f9] px-1 ' href='https://xiaomixiaomi.ir/'  >  سایت</a> شوید 
     ...
     md:h-[200px] fixed bottom-[15px] left-[5%] right-[5%] mx-auto rounded-br-3xl rounded-tl-3xl 
      bg-gradient-to-t from-[#8229d5] to-[#f9f9f9]   '>
       ...
       <p className='text-2xl text-center font-bold text-[#1e142c] mr-5'>سایت شرکتی پتروفولاد غرب</p>  </div>
       
        <p dir='rtl' className='text-md text-justify font-sans text-[#1e142c] mr-5 my-1'>ایجاد و پشتیبانی از سایت را انجام داده ام و در حال تغییر و توسعه میباشد. برای مشاهده ی بیشتر وارد  
      ...
      bg-gradient-to-t from-[#8229d5] to-[#f9f9f9]   '>
        <div  className='flex flex-row justify-between my-1 md:my-5  w-full h-auto'> 
         ...
         <a href='https://reactstor-nahall.onrender.com'>
          <LuSquareArrowOutDownLeft className='w-6 h-6 ml-5 text-[#1e142c] font-bold'/></a>
       <p className='text-2xl text-center font-bold text-[#1e142c] mr-5'>سایت نهال شاپ </p>  </div>
       
        <p dir='rtl' className='text-md text-justify font-sans text-[#1e142c] mr-5 my-1'>پروژه ی تمرینی و نمونه کار که با استفاده از react-js , taillwind-css , توسعه داده شده است . برای مشاهده ی بیشتر وارد 
      ...
      bg-gradient-to-t from-[#8229d5] to-[#f9f9f9]   '>
        <div  className='flex flex-row justify-between my-1 md:my-5  w-full h-auto'> 
         ...
         <a href='https://project-sohil.onrender.com'>
          <LuSquareArrowOutDownLeft className='w-6 h-6 ml-5 text-[#1e142c] font-bold'/></a>
       <p className='text-2xl text-center font-bold text-[#1e142c] mr-5'>سایت فروشگاهی سهیل </p>  </div>
       
        <p dir='rtl' className='text-md text-justify font-sans text-[#1e142c] mr-5 my-1'>پروژه ی تمرینی و نمونه کار که با استفاده از react-js , taillwind-css ,material-ui توسعه داده شده است . برای مشاهده ی بیشتر وارد 
      ...
      bg-gradient-to-t from-[#8229d5] to-[#f9f9f9]   '>
        <div  className='flex flex-row justify-between my-1 md:my-5  w-full h-auto'> 
         ...
         <a href='https://farhangian-saite.onrender.com'>
          <LuSquareArrowOutDownLeft className='w-6 h-6 ml-5 text-[#1e142c] font-bold'/></a>
       <p className='text-2xl text-center font-bold text-[#1e142c] mr-5'>سایت شخصی فرهنگیان </p>  </div>
       
        <p dir='rtl' className='text-md text-justify font-sans text-[#1e142c] mr-5 my-1'>سایت شخصی فرهنکیان توسعه دهنده ی وب , توسعه داده شده با next-js , taillwind-css 
        </p>
         </div>
     :  <div className='hidden justify-center w-[55%] h-[200px] mx-auto bg-blue-gray-300'> </div>
